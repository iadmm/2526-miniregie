/**
 * Dev seed — inserts fake participants and media items for local development.
...
console.log(`[seed-dev] Inserted ${fakeParticipants.length} fake participants.`);

// Shorthand: resolve participant IDs by username
function pid(username: string): string {
  const p = fakeParticipants.find(p => p.username === username)!;
...
const fakeItems: ItemInsert[] = [
  ...
  // ── Photos (picsum.photos placeholders) ───────────────────────────────────
  {
    ...
    type:        'photo',
    content:     {
      url:     'https://picsum.photos/seed/jam1/1280/720',
      caption: 'Ambiance plateau — 2h du matin',
    },
    priority:    100,
    status:      'ready',
  ...
  },
  {
    ...
    type:        'photo',
    content:     {
      url:     'https://picsum.photos/seed/jam2/1280/720',
      caption: null,
    },
    priority:    100,
    status:      'ready',
  ...
  },
  {
    ...
    type:        'photo',
    content:     {
      url:     'https://picsum.photos/seed/jam3/1280/720',
      caption: 'Équipe Rouge en plein tournage',
    },
    priority:    100,
    status:      'ready',
  ...
  },
  {
    ...
    type:        'photo',
    content:     {
      url:     'https://picsum.photos/seed/jam4/1280/720',
      caption: 'Répétition de la scène finale',
    },
    priority:    100,
    status:      'ready',
  ...
  },
  {
    ...
    type:        'photo',
    content:     {
      url:     'https://picsum.photos/seed/jam5/1280/720',
      caption: null,
    },
    priority:    100,
    status:      'ready',
  ...
  },
  {
    ...
    type:        'photo',
    content:     {
      url:     'https://picsum.photos/seed/jam6/1280/720',
      caption: 'Régie son — Félix aux commandes',
    },
    priority:    100,
    status:      'ready',
  ...
  },
  {
    ...
    type:        'photo',
    content:     {
      url:     'https://picsum.photos/seed/jam7/1280/720',
      caption: 'Coulisses — Équipe Jaune',
    },
    priority:    100,
    status:      'ready',
  ...
  },
  {
    ...
    type:        'photo',
    content:     {
      url:     'https://picsum.photos/seed/jam8/1280/720',
      caption: null,
    },
    priority:    100,
    status:      'ready',
  ...
  // ── Clips (fake local paths — won't play, exist for queue display) ─────────
  {
    ...
    type:        'clip',
    content:     {
      url:      '/uploads/fake-clip-01.mp4',
      duration: 47,
      mimeType: 'video/mp4',
      caption:  'Teaser scène 1 — Équipe Bleue',
    },
    priority:    100,
    status:      'ready',
  ...
  },
  {
    ...
    type:        'clip',
    content:     {
      url:      '/uploads/fake-clip-03.mp4',
      duration: 28,
      mimeType: 'video/mp4',
      caption:  'Interview improvisée dans le couloir',
    },
    priority:    100,
    status:      'ready',
  ...
  },
  {
    ...
    type:        'clip',
    content:     {
      url:      '/uploads/fake-clip-04.mp4',
      duration: 83,
      mimeType: 'video/mp4',
      caption:  'BTS montage nuit — Équipe Verte',
    },
    priority:    100,
    status:      'ready',
  ...
  },
  {
    ...
    content:     {
      ...
      caption:   'Pour garder l\'énergie à 4h du mat',
    },
    priority:    100,
    status:      'ready',
...
console.log(`[seed-dev] Inserted ${fakeItems.length} fake media items.`);
